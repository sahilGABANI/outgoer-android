...
import com.outgoer.base.prefs.OutgoerSharedPreferences
import io.reactivex.Observable

class LocalPrefs(context: Context) {

    private val sharedPrefs = context.getSharedPreferences(OutgoerSharedPreferences.PREFERENCE_NAME, Context.MODE_PRIVATE)
