...
public class RectangleShapeableImageView extends ShapeableImageView {
    ...
    public RectangleShapeableImageView(Context context) {
        super(context);
    }

    public RectangleShapeableImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
