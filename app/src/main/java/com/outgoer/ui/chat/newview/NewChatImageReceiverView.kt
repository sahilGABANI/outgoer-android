...
import com.outgoer.databinding.PopUpViewChatImageReceiverBinding
import com.outgoer.databinding.PopUpViewChatImageSenderBinding
import com.outgoer.databinding.ViewNewChatImageReceiverBinding
import io.reactivex.Observable
import io.reactivex.subjects.PublishSubject

class NewChatImageReceiverView(context: Context) : ConstraintLayoutWithLifecycle(context) {
    ...
    private val chatMediaViewClicksSubject: PublishSubject<ChatMessageInfo> =
    ...
    private var binding: ViewNewChatImageReceiverBinding? = null
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_new_chat_image_receiver, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewNewChatImageReceiverBinding.bind(view)
        binding?.let {
    ...
    private fun showCustomPopupMenu(longPressedView: View) {
        ...
        val popupView = PopUpViewChatImageReceiverBinding.inflate(LayoutInflater.from(context), parentView, false)
        ...
        if (::chatMessageInfo.isInitialized) {
            with(popupView) {
                ...
                if (MessageType.Video.equals(chatMessageInfo.fileType)) {
                    Glide.with(context)
                ...
                setClickListener(firstLayout, MoreActionsForTextActionState.DeleteMessage(chatMessageInfo))
