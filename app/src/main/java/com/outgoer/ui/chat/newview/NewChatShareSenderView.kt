...
import com.outgoer.databinding.PopUpViewChatShareSenderBinding
import com.outgoer.databinding.ViewNewChatImageSenderBinding
import com.outgoer.databinding.ViewNewChatShareSenderBinding
import io.reactivex.Observable
import io.reactivex.subjects.PublishSubject

class NewChatShareSenderView(context: Context) : ConstraintLayoutWithLifecycle(context) {
    ...
    private var binding: ViewNewChatShareSenderBinding? = null
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_new_chat_share_sender, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewNewChatShareSenderBinding.bind(view)
        binding?.let {
    ...
    private fun showCustomPopupMenu(longPressedView: View) {
        ...
        val binding = PopUpViewChatShareSenderBinding.inflate(LayoutInflater.from(context), parentView, false)
