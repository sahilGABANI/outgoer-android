...
class NewChatImageSenderView(context: Context) : ConstraintLayoutWithLifecycle(context) {
    ...
    private var binding: ViewNewChatImageSenderBinding? = null
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_new_chat_image_sender, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewNewChatImageSenderBinding.bind(view)
        binding?.let {
    ...
    private fun showCustomPopupMenu(longPressedView: View) {
        ...
        val popupView = PopUpViewChatImageSenderBinding.inflate(LayoutInflater.from(context), parentView, false)
        ...
        val marginBottom = context.resources.getDimensionPixelSize(com.intuit.sdp.R.dimen._60sdp)
        ...
        val adjustedXPos = minOf(xPos, screenWidth - popupView.root.measuredWidth - marginRight)
