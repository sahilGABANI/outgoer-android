...
import com.outgoer.databinding.PopUpViewChatTextReplySenderBinding
import com.outgoer.databinding.ViewNewChatTextReplySenderBinding
import io.reactivex.Observable
import io.reactivex.subjects.PublishSubject

class NewChatTextReplySenderView(context: Context) : ConstraintLayoutWithLifecycle(context) {

    private var binding: ViewNewChatTextReplySenderBinding? = null
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_new_chat_text_reply_sender, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewNewChatTextReplySenderBinding.bind(view)

        binding?.let {
            it.mainLayout.setOnLongClickListener {view ->
                highlightItem()
    ...
    private fun showCustomPopupMenu(longPressedView: View) {
        ...
        val binding = PopUpViewChatTextReplySenderBinding.inflate(LayoutInflater.from(context), parentView, false)
        ...
        if (::chatInfo.isInitialized) {
            with(binding) {
                replyUsername.text = chatInfo.replyName
                messageReply.text = chatInfo.message
                senderAppCompatTextView.text = chatInfo.replyMessage
    ...
    fun bind(chatMessageInfo: ChatMessageInfo) {
        ...
        binding?.apply {
            ...
            messageReply.text = chatMessageInfo.message
            senderAppCompatTextView.text = chatMessageInfo.replyMessage
