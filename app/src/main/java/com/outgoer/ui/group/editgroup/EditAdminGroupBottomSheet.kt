...
class EditAdminGroupBottomSheet : BaseBottomSheetDialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(): EditAdminGroupBottomSheet {
            return EditAdminGroupBottomSheet()
        }

        @JvmStatic
        fun newInstanceWithData(chatConversationInfo: ChatConversationInfo, userId: Int): EditAdminGroupBottomSheet {
            var editGroupBottomSheet = EditAdminGroupBottomSheet()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            binding.makeAdminAppCompatTextView.setText(resources.getString(R.string.label_dismiss_as_admin))
    ...
    private fun listenToViewEvents() {
        ...
        binding.makeAdminAppCompatTextView.throttleClicks().subscribeAndObserveOnMainThread {
            groupViewModel.removeGroupAdminUser(ManageGroupRequest(chatConversationInfo?.id, userId))
        }
        ...
        groupViewModel.groupState.subscribeAndObserveOnMainThread {
            when (it) {
                is GroupViewModel.GroupViewState.ErrorMessage -> {
                    showLongToast(it.errorMessage.toString())
                }
                is GroupViewModel.GroupViewState.RemoveAdminSuccessMessage -> {
