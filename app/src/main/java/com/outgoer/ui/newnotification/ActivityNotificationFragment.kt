...
class ActivityNotificationFragment : BaseFragment() {
    ...
    private var _binding: FragmentActivityNotificationBinding? = null
    private val binding get() = _binding!!

    private lateinit var activityNotificationAdapter: ActivityNotificationAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?, ): View? {
        _binding = FragmentActivityNotificationBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//        }.autoDispose()
        ...
        activityNotificationAdapter = ActivityNotificationAdapter(requireContext())
