...
final class PausableProgressBar extends FrameLayout {
    ...
    void setMinWithoutCallback() {
        maxProgressView.setBackgroundResource(R.drawable.story_max_progress);
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(R.drawable.story_front_progress);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(R.drawable.story_front_progress);
