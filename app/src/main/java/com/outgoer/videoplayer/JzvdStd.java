...
public class JzvdStd extends Jzvd {
    ...
    public void init(Context context) {
        ...
        if (bottomProgressBar == null) {
            bottomProgressBar = new SeekBar(context);
        }
        ...
        bottomProgressBar.setOnSeekBarChangeListener(this);
    }
    ...
    public void setUpProgress(JZDataSource jzDataSource, int screen, Class mediaInterfaceClass, int showProgressBar) {
        if ((System.currentTimeMillis() - gobakFullscreenTime) < 200) {
            return;
        }
...
//        bottomProgressBar.setProgress(100);
        progressState = 100;
//        setProgressAnimate(bottomProgressBar, 100);
    }
...
//        super.startProgressTimer();
        ...
        UPDATE_PROGRESS_TIMER.schedule(mProgressTimerTask, 0, 60);
    }
...
//                        setProgressAnimate(bottomProgressBar, progress);
                    }
                    break;
            }
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    public void onProgress(int progress, long position, long duration) {
        ...
        bottomProgressBar.setProgress(progress, true);
    }
